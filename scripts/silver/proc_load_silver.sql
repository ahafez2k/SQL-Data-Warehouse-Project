...
Script Purpose:
    ...
    puplote the 'silver' schema tables from the 'bronze'schema.
        Actions Performoed:
...
BEGIN
    ...
    BEGIN TRY
        ...
        PRINT '>> Truncating Tabl: silver.crm_cust_info';
        ...
        SELECT
            ...
            CASE WHEN bdate > GETDATE() THEN NULL
                ELSE bdate
            END bdate,  
            CASE WHEN UPPER(TRIM(gen)) IN ('F', 'FEMAL') THEN 'Female'
